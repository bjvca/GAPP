...
set more off
if c(os)=="Unix" {
global path "/home/bjvca/data/data/GAP/Haruna/UNPS_2011_12/"
}
else{
...
replace survquar=3 if month>=5 & month<=7  & year==2012
replace survquar=4 if month>=8 & month<=10  & year==2012
replace survquar=5 if month>=11 & month<=12  & year==2012 | month == 1 & year == 2013
tab survquar
label define lsurvquar 1 "Nov '11 - Jan-'12" 2 "Feb-Apr 12" 3 "May-July 12" 4 "Aug-Oct 2012" 5 "Nov&Dec '12 - Jan '13"
label values survquar lsurvquar
label variable survquar "Sequential Survey Quarter (Nov'11 - Jan '13)"
...
gen float survmon=1 if month==11 & year==2011
replace survmon=2 if month==12 & year==2011
replace survmon=3 if month==1 & year==2012
replace survmon=4 if month==2 & year==2012
replace survmon=5 if month==3 & year==2012
replace survmon=6 if month==4 & year==2012
replace survmon=7 if month==5 & year==2012
replace survmon=8 if month==6 & year==2012
replace survmon=9 if month==7 & year==2012
replace survmon=10 if month==8 & year==2012
replace survmon=11 if month==9 & year==2012				
replace survmon=12 if month==10 & year==2012
replace survmon=13 if month==11 & year==2012
replace survmon=14 if month==12 & year==2012 | month==1 & year==2013
