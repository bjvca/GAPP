...
/
$include D:\data\GAP\Haruna\work\product_flex.inc
/
...
Table  price(cod,reg,ptit)  price and related information
                        count   price_uw5
$include D:\data\GAP\Haruna\work\price_unit_flex.inc
;

Table   quan(cod,reg,qtit)   quantity and related information
                           calperg          quan5           calpp      povline_a_flex5
$include D:\data\GAP\Haruna\work\quan_flex.inc
;
...
file povline_rp /D:\data\GAP\Haruna\work\povline_rp_inout.csv/;
put povline_rp;
povline_rp.pc=5;
povline_rp.nd=0;
put " ";
...
*readjust quantities to hit regional calorie target and calculate line;
   ...
   file res /D:\data\GAP\Haruna\work\qent.csv/;
...
*recall that the basket reflects 90% of expenditure and 95% of calories";
   ...
   file lin /D:\data\GAP\Haruna\work\povline_food_ent.csv/;
