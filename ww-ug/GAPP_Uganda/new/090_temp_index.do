...
* in KGs where both value and quantity are available. For IOF 2009 non-KG
* observations are converted into KG just like in a lot other places
* imn the code.
**************************************************************************;
...
* Not trimmed ;
        collapse (sum) tpi1 tpi1_trim  , by(reg_tpi survquar);
                ...
                for num 1/$n_tpi :
                        ...
                        global baseX=r(mean);
                lab var tpi1 "Six regions: Temporal price index before normalization";
                ...
                lab var tpi "Six regions: Temporal price index (Q4=1)";
...
* Trimmed ;
                ...
                gen     tpi_trim=tpi1_trim/$base1 if reg_tpi==1;
                replace tpi_trim=tpi1_trim/$base2 if reg_tpi==2;
                replace tpi_trim=tpi1_trim/$base3 if reg_tpi==3;
                replace tpi_trim=tpi1_trim/$base4 if reg_tpi==4;
                replace tpi_trim=tpi1_trim/$base5 if reg_tpi==5;
                replace tpi_trim=tpi1_trim/$base6 if reg_tpi==6;
                lab var tpi_trim "Six regions: TRIMMED Temporal price index (Q4=1)";
...
lab var tpi_diff "Six regions: TPI difference btw trimmed/untrimmed";
