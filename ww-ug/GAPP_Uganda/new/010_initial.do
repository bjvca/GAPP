...
* Number of items;
global product_tpi_n "15";    /* UGANDA 2009: not ajusted yet */

* Code choose $product_tpi_n ;
global product_tpi   "product_tpi==1";		 /* UGANDA 2009: not ajusted yet */
...
global tpi_bottom "50";													 /* UGANDA 2009: not ajusted yet */

* Set the number of regions in the TPI calc;
global n_tpi "6";    /* UGANDA 2009: not ajusted yet */

******************************************************************************
* Initial (arbitrary) quantile defining the (relatively) poor.
******************************************************************************;
global bottom "60"; /* UGANDA 2009: not ajusted yet */

******************************************************************************
* Number of iterations in 140_iterate.do
******************************************************************************;
global it_n "5"; /* UGANDA 2009: not ajusted yet */

******************************************************************************
* Set the number of regions in the spatial domain;
******************************************************************************;
global n_spdom "8";		 /* UGANDA 2009: ajusted  */
