...
/
$include C:\Users\Templeton\Desktop\GAPP\GAPP-UGANDA-HARUNA\ww-ug\10_MZ\work\product_flex.inc
/

 reg        9 spatial domains /1*9/
 r(reg)     non maputo spatial regions /1*9/
...
Table  price(cod,reg,ptit)  price and related information
                        count   price_uw5
$include  C:\Users\Templeton\Desktop\GAPP\GAPP-UGANDA-HARUNA\ww-ug\10_MZ\work\price_unit_flex.inc
;

Table   quan(cod,reg,qtit)   quantity and related information
                           calperg          quan5           calpp      povline_a_flex5
$include C:\Users\Templeton\Desktop\GAPP\GAPP-UGANDA-HARUNA\ww-ug\10_MZ\work\quan_flex.inc
;
...
file povline_rp  /C:\Users\Templeton\Desktop\GAPP\GAPP-UGANDA-HARUNA\ww-ug\10_MZ\work\povline_rp_inout.csv/;
put povline_rp;
povline_rp.pc=5;
povline_rp.nd=0;
put " ";
...
*readjust quantities to hit regional calorie target and calculate line;
   ...
   file res /C:\Users\Templeton\Desktop\GAPP\GAPP-UGANDA-HARUNA\ww-ug\10_MZ\work\qent.csv/;
...
*recall that the basket reflects 90% of expenditure and 95% of calories";
   ...
   file lin  /C:\Users\Templeton\Desktop\GAPP\GAPP-UGANDA-HARUNA\ww-ug\10_MZ\work\povline_food_ent.csv/;
