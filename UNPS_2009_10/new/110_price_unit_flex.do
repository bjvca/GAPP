...
********************************************************************* 
		...
		*CA modified to count the boot sample weight bswt 
        collapse (sum) quantity value_r count bswt (mean) price_unitt (median) price_unitm [aw=hhweight], by(spdomain product) 
      ...
      *  replace price_unitw =price_unitw*143.99/188.69  
