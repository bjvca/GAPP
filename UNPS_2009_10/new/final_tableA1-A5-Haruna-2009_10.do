...
gen float spdomain=1 if strata==1 | strata==11
replace spdomain=2 if strata==10
replace spdomain=3 if strata==20 | strata==21
replace spdomain=4 if strata==30 | strata==31
replace spdomain=5 if strata==40 | strata==41
