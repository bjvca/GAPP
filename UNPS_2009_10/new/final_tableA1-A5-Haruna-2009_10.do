...
set more off
if c(os)=="Unix" {
global path "/home/bjvca/data/data/GAP/Haruna/UNPS_2009_10/"
}
else{
global path "C:\Users\Haruna\Desktop\GAPP\UNPS_2009_10"
}
...
gen float survquar=1 if h1bq2b>=9 & h1bq2b<=11 & h1bq2c==2009 
replace survquar=2 if h1bq2b>=12 & h1bq2c == 2009 | h1bq2b>=1 & h1bq2b<=2  & h1bq2c==2010
replace survquar=3 if h1bq2b>=3 & h1bq2b<=6  & h1bq2c==2010
replace survquar=4 if h1bq2b>=7 & h1bq2b<=9  & h1bq2c==2010
replace survquar=5 if h1bq2b>=10 & h1bq2b<=12  & h1bq2c==2010
tab survquar
label define lsurvquar 1 "Sept '09 - Nov-'09" 2 "Dec '09-Feb 10" 3 "March-Jun 10" 4 "Jul-Sept 2010" 5 "Oct-Dec '10"
label values survquar lsurvquar
label variable survquar "Sequential Survey Quarter (Sep'09 - Dec '10)"
...
gen float survmon=1 if h1bq2b==9 & h1bq2c==2009
replace survmon=2 if h1bq2b==10 & h1bq2c==2009
replace survmon=3 if h1bq2b==11 & h1bq2c==2009
replace survmon=4 if h1bq2b==12 & h1bq2c==2009
replace survmon=5 if h1bq2b==1 & h1bq2c==2010
replace survmon=6 if h1bq2b==2 & h1bq2c==2010
replace survmon=7 if h1bq2b==3 & h1bq2c==2010
replace survmon=8 if h1bq2b==4 & h1bq2c==2010
replace survmon=9 if h1bq2b==5 & h1bq2c==2010
replace survmon=10 if h1bq2b==6 & h1bq2c==2010
replace survmon=11 if h1bq2b==7 & h1bq2c==2010				
replace survmon=12 if h1bq2b==8 & h1bq2c==2010
replace survmon=13 if h1bq2b==9 & h1bq2c==2010
replace survmon=14 if h1bq2b==10 & h1bq2c==2010 
replace survmon=15 if h1bq2b==11 & h1bq2c==2010
replace survmon=16 if h1bq2b==12 & h1bq2c==2010

**** there was only one person in January 2013, hence it is added on to Dec '12
label define lsurvmon 1 "Nov 11" 2 "Dec 11" 3 "Jan 12" 4 "Feb 12" 5 "Mar 12" 6 "Apr 12" 7 "May 12" 8 "June 12" 9 "July 12" 10 "Aug 12" 11 "Sept 12" 12 "Oct 12" 13 " Nov 12" 14 " Dec 12 & Jan '13"
label values survmon lsurvmon
tab survmon,m
label variable survmon "Sequential Survey Month (November 2011 = January '13)"
***------- Household Sample Weight
rename wgt09wosplits hhweight
...
*--------------+-----------------------------------
*      Kampala |        242        8.14        8.14
*Central rural |        520       17.50       25.64
*Central urban |        177        5.96       31.59
*   East rural |        570       19.18       50.77
*   East urban |        114        3.84       54.61
*  North rural |        588       19.78       74.39
*  North urban |        122        4.10       78.50
*   West rural |        525       17.66       96.16
*   West urban |        114        3.84      100.00
*--------------+-----------------------------------
*        Total |      2,972      100.00
...
gen float spdomain=1 if  strata==11  | strata==10  | strata==1

replace spdomain=2 if strata==20 | strata==21
replace spdomain=3 if strata==30 | strata==31
replace spdomain=4 if strata==40 | strata==41


label define lspdomain 1 "Central" 2 "East" 3 "Northern" 4 "Western" 
...
codebook indid
* There are 18,313 unique values, and there are 18,313 observations in the dataset so indid uniquely identifies the data
...
label variable indid "Individual ID"
codebook indid
* There are 16,512 unique values, and there are 16,512 observations in the dataset so indid uniquely identifies data
*duplicates report indid
*duplicates list indid
*duplicates drop indid, force
*codebook indid 
...
replace motherhh=0 if h3q5==2 | h3q5==3 | h3q5==.
...
clear
use "$path/in/foodcomp_uganda_PANNELsurvey2009.dta"
