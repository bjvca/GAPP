* Filename: 190a_spat_consistent.gms
...
SETS
 cod        codes for products used in basket
/
...
Table  price(cod,reg,ptit)  price and related information
                        count   price_uw5
$include /home/bjvca/data/data/GAP/Haruna/UNHS_2012/work/price_unit_flex.inc
;

Table   quan(cod,reg,qtit)   quantity and related information
                           calperg          quan5           calpp      povline_a_flex5
$include /home/bjvca/data/data/GAP/Haruna/UNHS_2012/work/quan_flex.inc
;
...
*fill out price matrix with maximum observed price

*$ontext
*IMPROVED approach
*drop prices with insufficient observations
price(cod,r,'price_uw5')$(NOT posprice(cod,r))=0;

parameter
 price1(cod,reg) holding price parameter;
 price1(cod,reg)$posprice(cod,reg)= price(cod,reg,'price_uw5');


loop((cod,r)$(NOT posprice(cod,r)),
         loop(rq,
                 price1(cod,r)=max(price1(cod,r),
                                              price(cod,rq,'price_uw5'));
         );
);

price1(cod,r)$(NOT sum(rq,quan(cod,rq,'quan5')))=0;
price(cod,r,'price_uw5')=0;
price(cod,r,'price_uw5')=price1(cod,r);
*$offtext
...
file povline_rp/"/home/bjvca/data/data/GAP/Haruna/UNHS_2012/work/povline_rp_inout.csv"/;
put povline_rp;
povline_rp.pc=5;
povline_rp.nd=0;
put " ";
...
put /; put /; put /;
   ...
   abort$(revpref.modelstat ne 2) "minimum cross entropy procedure is not optimal";
...
*readjust quantities to hit regional calorie target and calculate line;
  ...
  file res/"/home/bjvca/data/data/GAP/Haruna/UNHS_2012/work/qent.csv"/;
...
*recall that the basket reflects 90% of expenditure and 95% of calories";
   ...
   file lin/"/home/bjvca/data/data/GAP/Haruna/UNHS_2012/work/povline_food_ent.csv"/;
